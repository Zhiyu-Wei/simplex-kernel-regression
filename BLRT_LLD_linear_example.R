...
##  Main script (uses functions in: dirichlet_locallinear_functions.R)
## ============================================================
...
## Path setting (make sure this folder exists)
base_path <- "C:\\Users\\first\\OneDrive\\桌面\\paper\\BLRT WLS linear beta=0"
